...
export type WSMessageType = 'room:create' | 'room:join' | 'room:rejoin' | 'room:leave' | 'room:state' | 'room:ready' | 'room:start' | 'room:error' | 'participant:update' | 'participant:joined' | 'participant:left' | 'signal:offer' | 'signal:answer' | 'signal:ice' | 'timer:update' | 'timer:start' | 'timer:pause' | 'speech:start' | 'speech:end' | 'prep:start' | 'prep:end' | 'error' | 'audio:start' | 'audio:chunk' | 'audio:stop' | 'stt:interim' | 'stt:final' | 'translation:interim' | 'translation:complete' | 'flow:argument' | 'flow:state' | 'ballot:ready' | 'latency:update' | 'tts:start' | 'tts:audio_chunk' | 'tts:end' | 'tts:error' | 'voice:select' | 'voice:list:request' | 'voice:list' | 'debate:timeout_warning' | 'debate:timeout_end' | 'bot:room:create' | 'bot:prep:start' | 'bot:prep:end' | 'bot:speech:generating' | 'bot:speech:ready' | 'bot:speech:skip' | 'bot:transcript:chunk' | 'ping' | 'pong';
