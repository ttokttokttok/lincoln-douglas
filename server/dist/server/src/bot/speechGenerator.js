...
import { generateSystemPrompt, generateUserPrompt, getTargetWordCount, } from './characterPrompts.js';
class BotSpeechGenerator {
    ...
    async generateSpeech(context) {
        ...
        try {
            // Build the prompts
            const systemPrompt = generateSystemPrompt(context.character, context.speech, context.side);
            const userPrompt = generateUserPrompt(context.resolution, context.speech, context.opponentArguments, context.ownArguments, context.flowTranscripts);
     ...
     */
    async generateOpeningSpeech(resolution, speech, side, character, language) {
     ...
     */
    async preGenerateSpeech(roomId, context) {
...
//# sourceMappingURL=speechGenerator.js.map