...
class ElevenLabsTTSService {
    ...
    async generateStream(options) {
        ...
        try {
            ...
            const url = new URL(`${this.config.baseUrl}/v1/text-to-speech/${voiceId}/stream`);
